...
let AuthController = class AuthController {
    ...
    async requestResetPassword(requestResetDto) {
    ...
    async resetPassword(resetPasswordDto) {
        const { success, message } = await this.authService.resetPassword(resetPasswordDto.token, resetPasswordDto.newPassword);
        if (!success) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [reset_password_dto_1.RequestResetDto]),
    __metadata("design:returntype", Promise)
